...
<div style="display: flex; justify-content: space-between;">
  <div style="width: 48%;">
    <img src="imgs/block1.png" alt="Block Size vs. CPI" style="width: 100%;"/><br>
    *Figure 1: Block Size vs. CPI*
  </div>
  <div style="width: 48%;">
    <img src="imgs/block2.png" alt="Block Size vs. Miss Rate" style="width: 100%;"/><br>
...
<div style="display: flex; justify-content: space-between;">
  <div style="width: 48%;">
    <img src="imgs/cache1.png" alt="Cache Size vs. CPI" style="width: 100%;"/><br>
    *Figure 4: Cache Size vs. CPI*
  </div>
  <div style="width: 48%;">
    <img src="imgs/cache2.png" alt="Cache Size vs. Miss Rate" style="width: 100%;"/><br>
...
<div style="display: flex; justify-content: space-between;">
  <div style="width: 32%;">
    <img src="imgs/asso4.png" alt="Cache Size 4KB" style="width: 100%;"/><br>
    *Figure 7: Cache Size 4KB*
  </div>
  <div style="width: 32%;">
    <img src="imgs/asso16.png" alt="Cache Size 16KB" style="width: 100%;"/><br>
    *Figure 8: Cache Size 16KB*
  </div>
  <div style="width: 32%;">
    <img src="imgs/asso64.png" alt="Cache Size 64KB" style="width: 100%;"/><br>
...
<img src="imgs/p2.png" alt="The Cache performance of different settings" width="40%"/><br>
*Figure 1: The Cache performance of different settings*

<img src="imgs/default.png" alt="Default cache setting used in multi-level cache simulation" width="40%"/><br>
*Figure 2: Default cache setting used in multi-level cache simulation*
...
<div style="display: flex; justify-content: space-between;">
  <div style="width: 48%;">
    <img src="imgs/q.png" alt="Without Cache" style="width: 100%;"/><br>
    *Figure 1: Without Cache*
  </div>
  <div style="width: 48%;">
    <img src="imgs/qc.png" alt="With Cache" style="width: 100%;"/><br>
    *Figure 2: With Cache*
  </div>
</div>
...
<div style="display: flex; justify-content: space-between;">
  <div style="width: 48%;">
    <img src="imgs/a.png" alt="Without Cache" style="width: 100%;"/><br>
    *Figure 4: Without Cache*
  </div>
  <div style="width: 48%;">
    <img src="imgs/ac.png" alt="With Cache" style="width: 100%;"/><br>
    *Figure 5: With Cache*
  </div>
</div>
